    ...
    <div class="bc-header-inner">
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>" class="bc-header-logo">
            <?php if (has_custom_logo()) :
                ...
                echo '<img src="' . esc_url($logo_url) . '" alt="' . esc_attr(get_bloginfo('name')) . '" height="27" loading="eager">';
            else : ?>
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/logo-faq.png'); ?>" alt="Beycome FAQ" height="27" loading="eager">
            <?php endif; ?>
        </a>
