...
function beycome_blog_enqueue() {
    wp_enqueue_style('beycome-blog-main', get_template_directory_uri() . '/assets/main.css', [], '1.7.74');
    wp_enqueue_script('beycome-blog-js', get_template_directory_uri() . '/assets/blog.js', [], '1.7.74', true);
}
